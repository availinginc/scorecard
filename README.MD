...
VALUES (CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'pinpointscore', 'Pinpoint', 'Score', 'pinpointscore@example.com', 'USA', 'Buffalo', 'Country Club of Internet', 0);
```
...
WHERE user_id = 1 AND submitted = '2023-10-01 12:00:00';
```
